    ...
    fluidRow(uiOutput("urlimports"),
      tabItems(
        ...
        tabItem(tabName="pmct", h2("Analyse du PMCT et de ses variations"), 
                shinydashboard::box(plotOutput(outputId="pmct1"), width = 12, solidHeader = TRUE, collapsible = TRUE, collapsed =FALSE, title = "Evoution mensuelle du PMCT", status = "primary"),
