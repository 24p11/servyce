...
function(input, output, session) {
  ...
  ########################################################################################
  #Contruction et chargement des données à partir fichiers RData sur le disque (datapath)
  ########################################################################################
  ...
  observeEvent( input$build, {
    ...
    withProgress( message = "Chargement", value = 0, {
      ...
      mese <<- as.numeric(input$mese)
      anonconsol <<- anno-1
      mnonconsol <<- mese
      
      #load courant
      
      assign(paste0("rsa_", anno, mese), NULL)
      assign(paste0("rsa_v_", anno, mese), NULL)
      assign(paste0("rum_", anno, mese), NULL)
      assign(paste0("rum_v_", anno, mese), NULL)
      assign(paste0("pmctmono_", anno, mese), NULL)
      assign(paste0("diagnostics_", anno, mese), NULL)
      
      for (site in sites) {
        load(paste0(datapath, site, ".", anno, ".", mese, ".RData"))
        assign(paste0("rsa_", anno, mese), bind_rows( get(paste0("rsa_", anno, "_", mese)), get(paste0("rsa_", anno, mese)) ) )
        assign(paste0("rsa_v_", anno, mese), bind_rows( get(paste0("rsa_v_", anno, "_", mese)), get(paste0("rsa_v_", anno, mese)) ) )
        assign(paste0("rum_", anno, mese), bind_rows( get(paste0("rum_", anno, "_", mese))[["rum"]], get(paste0("rum_", anno, mese)) ) )
        assign(paste0("rum_v_", anno, mese), bind_rows( get(paste0("rum_v_", anno, "_", mese)), get(paste0("rum_v_", anno, mese)) ) )
        assign(paste0("pmctmono_", anno, mese), bind_rows( get(paste0("pmctmono_", anno, "_", mese)), get(paste0("pmctmono_", anno, mese)) ) %>% dplyr::ungroup() %>% dplyr::mutate(ansor=as.character(anno)) )
        assign(paste0("diagnostics_", anno, mese), bind_rows( get(paste0("rum_", anno, "_", mese))[["diags"]], get(paste0("diagnostics_", anno, mese)) ) )
      }
      ...
      assign(paste0("rsa_", anno-1, "12"), NULL)
      assign(paste0("rsa_v_", anno-1, "12"), NULL)
      assign(paste0("rum_", anno-1, "12"), NULL)
      assign(paste0("rum_v_", anno-1, "12"), NULL)
      assign(paste0("pmctmono_", anno-1, "12"), NULL)
      assign(paste0("diagnostics_", anno-1, "12"), NULL)
      
      for (site in sites) {
        load(paste0(datapath, site, ".", anno-1, ".12.RData"))
        assign(paste0("rsa_", anno-1, "12"), bind_rows( get(paste0("rsa_", anno-1, "_12")), get(paste0("rsa_", anno-1, "12")) ) )
        assign(paste0("rsa_v_", anno-1, "12"), bind_rows( get(paste0("rsa_v_", anno-1, "_12")), get(paste0("rsa_v_", anno-1, "12")) ) )
        assign(paste0("rum_", anno-1, "12"), bind_rows( get(paste0("rum_", anno-1, "_12"))[["rum"]], get(paste0("rum_", anno-1, "12")) ) )
        assign(paste0("rum_v_", anno-1, "12"), bind_rows( get(paste0("rum_v_", anno-1, "_12")), get(paste0("rum_v_", anno-1, "12")) ) )
        assign(paste0("pmctmono_", anno-1, "12"), bind_rows( get(paste0("pmctmono_", anno-1, "_12")), get(paste0("pmctmono_", anno-1, "12")) ) %>% dplyr::ungroup() %>% dplyr::mutate(ansor=as.character(anno-1)) )
        assign(paste0("diagnostics_", anno-1, "12"), bind_rows( get(paste0("rum_", anno-1, "_12"))[["diags"]], get(paste0("diagnostics_", anno-1, "12")) ) )
      }
      ...
      assign(paste0("rsa_", anno-1, mese), NULL)
      assign(paste0("rsa_v_", anno-1, mese), NULL)
      assign(paste0("rum_", anno-1, mese), NULL)
      assign(paste0("rum_v_", anno-1, mese), NULL)
      assign(paste0("pmctmono_", anno-1, mese), NULL)
      
      for (site in sites) {
        load(paste0(datapath, site, ".", anno-1, ".", mese, ".RData"))
        assign(paste0("rsa_", anno-1, mese), bind_rows( get(paste0("rsa_", anno-1, "_", mese)), get(paste0("rsa_", anno-1, mese)) ) )
        assign(paste0("rsa_v_", anno-1, mese), bind_rows( get(paste0("rsa_v_", anno-1, "_", mese)), get(paste0("rsa_v_", anno-1, mese)) ) )
        assign(paste0("rum_", anno-1, mese), bind_rows( get(paste0("rum_", anno-1, "_", mese))[["rum"]], get(paste0("rum_", anno-1, mese)) ) )
        assign(paste0("rum_v_", anno-1, mese), bind_rows( get(paste0("rum_v_", anno-1, "_", mese)), get(paste0("rum_v_", anno-1, mese)) ) )
        assign(paste0("pmctmono_", anno-1, mese), bind_rows( get(paste0("pmctmono_", anno-1, "_", mese)), get(paste0("pmctmono_", anno-1, mese)) ) %>% dplyr::ungroup() %>% dplyr::mutate(ansor=as.character(anno-1)) )
      }
      ...
      assign(paste0("rum_v_tarifs_anterieurs_", anno, mese), NULL)
      
      for (site in sites) {
        load(paste0(datapath, site, ".", anno, ".", mese, ".tarifs_anterieurs.RData"))
        assign(paste0("rum_v_tarifs_anterieurs_", anno, mese), bind_rows( get(paste0("rum_v_tarifs_anterieurs_", anno, "_", mese)), get(paste0("rum_v_tarifs_anterieurs_", anno, mese)) ) )
      }
      ...
      structs <- readxl::read_excel(strctr, col_types = c( "text" , "text" , "text" , "text" ,"text" , "text" , "text" , "text" , "text" ), col_names = c( 'nofiness', 'hopital', 'cdurm', 'uma_locale', 'uma_locale2', 'libelle_um', 'service', 'regroupement1', 'pole' ), skip = 1 )      
 
      #data prepare
      
      rsa <- dplyr::left_join(
        bind_rows(get(paste0("rsa_", anno, mese)),
                  get(paste0("rsa_", anno-1, "12"))), 
        bind_rows(get(paste0("rsa_v_", anno, mese)), 
                  get(paste0("rsa_v_", anno-1, "12"))))
      rum <- dplyr::left_join(structs, 
                              dplyr::left_join(bind_rows(get(paste0("rum_", anno, mese)), 
                                                         get(paste0("rum_", anno-1, "12"))), 
                                               bind_rows(get(paste0("rum_v_", anno, mese)), 
                                                         get(paste0("rum_v_", anno-1, "12")))) )
      
      pmctmono <<- bind_rows(get(paste0("pmctmono_", anno, mese)), get(paste0("pmctmono_", anno-1, "12")))
      diagnostics <<- bind_rows(get(paste0("diagnostics_", anno, mese)), get(paste0("diagnostics_", anno-1, "12")))
      
      pmctmono_nonconsol <- get(paste0("pmctmono_", anno-1, mese))
      rsa_nonconsol <- dplyr::left_join(get(paste0("rsa_", anno-1, mese)), get(paste0("rsa_v_", anno-1, mese)))
      rum_nonconsol <- dplyr::left_join(structs, dplyr::left_join(get(paste0("rum_", anno-1, mese)), get(paste0("rum_v_", anno-1, mese))) )
      ...
      dms1 <- referime::get_table('ghm_dms_nationales') %>% dplyr::filter(ghs!="") %>% 
        dplyr::bind_rows(., dplyr::filter(referime::get_table('ghm_dms_nationales') %>% 
                                            dplyr::filter(ghs!="")  %>% 
                                            dplyr::filter(anseqta==anno-1) %>% 
                                            dplyr::mutate(anseqta=as.character(anno))))
      dms2 <- referime::get_table('ghm_dms_nationales') %>% dplyr::filter(ghs=="") %>% 
        dplyr::bind_rows(., dplyr::filter(referime::get_table('ghm_dms_nationales') %>% 
                                            dplyr::filter(ghs=="")  %>% 
                                            dplyr::filter(anseqta==anno-1) %>% 
                                            dplyr::mutate(anseqta=as.character(anno))))
      ...
      reg2 <- referime::get_table('ghm_rghm_regroupement')
      #SI ANNEE MANQUANTE DANS LE REFERENTIEL: reg2 <- dplyr::bind_rows(referime::get_table('ghm_rghm_regroupement'), referime::get_table('ghm_rghm_regroupement') %>% dplyr::filter(anseqta=="2017") %>% dplyr::mutate(anseqta="2018"))
      ...
      #mutate rums and rsa
      rsaload <<- rsa %>% dplyr::filter(ansor>=anno-1) %>% 
        dplyr::mutate(ghs=noghs) %>% 
        dplyr::left_join(., dms1, suffix=c('','_temp')) %>% 
        dplyr::select(-ghs) %>% 
        dplyr::left_join(., dms2, suffix=c('', '_temp'), by=c('ghm', 'anseqta', 'rsavclass')) %>% 
        dplyr::mutate(dms_n=ifelse(is.na(dms_n), 
                                   dms_n_temp, dms_n), 
                      borne_basse=ifelse(is.na(borne_basse), 
                                         borne_basse_temp, borne_basse), 
                      borne_haute=ifelse(is.na(borne_haute), borne_haute_temp, borne_haute), 
                      # ip=duree/dms_n,
                      racine=paste0(rsacmd, rsatype, rsanum)) %>% 
        dplyr::select(-dms_n_temp, -borne_basse_temp, -borne_haute_temp) %>% dplyr::left_join(., reg2)
      
      #La variable LIBUM créée ci-dessous sert à gérer les regroupements d'unité 
      #(i.e.: une unité unique est construite avec l'ensemble des unités selectionnées dans l'appli, 
      #et les structures modifiées en fonction pour que tous les calculs prennent en compte cette nouvelle unité aggrégée)
      rumload <<- rum %>% dplyr::left_join(., rsaload %>% dplyr::select(cle_rsa, nas, norss, dms_n, nbrum_sej=nbrum, duree_sej=duree, racine_sej=racine, libelle_racine_sej=libelle_racine, da_sej=da, libelle_da_sej=libelle_da, gp_cas_sej=gp_cas, libelle_gp_cas_sej=libelle_gp_cas, ga_sej=ga, libelle_ga_sej=libelle_ga, da_gp_sej=da_gp, da_gp_ga_sej=da_gp_ga, aso_sej=aso)) %>% dplyr::left_join(., rum_tarifsante %>% dplyr::select(nas, norum, valotime, valopmctmono, valopmctmonotime1, valopmctmonotime2), suffix=c("","_tarifsante"), by=c('nas', 'norum')) %>% 
        dplyr::left_join(., rum_nonconsol %>% dplyr::filter(ansor==anno-1) %>% 
                           dplyr::select(nas, norum, valotime, valopmctmono, valopmctmonotime1, valopmctmonotime2), suffix=c("","_nonconsol"), by=c('nas', 'norum')) %>% 
        dplyr::group_by(nas) %>% dplyr::mutate(LIBUM=paste0(uma_locale2, " - ",libelle_um)) %>% 
        dplyr::ungroup() %>% 
        dplyr::rename(ansor_sej=ansor, moissor_sej=moissor, dms_n_sej=dms_n)
      
      structures <<- rumload  %>% dplyr::mutate(services=libelle_um, value=uma_locale2, label=paste0(uma_locale2, " - ", libelle_um)) %>% 
        dplyr::select(services, value, label) %>% unique()
  ...
  #################################################################
  #Charement des données préconstruites
  #################################################################
  ...
  observeEvent(input$scores, {
    ...
    withProgress( message = "Calcul", value = 0, {
      ...
      if(score==0) {
        ...
        charl <- comorbidity(x = diagnostics, id = "nas", code = "diag", score = "charlson", icd = "icd10", assign0 = FALSE) %>% 
          dplyr::select(nas, charl_score=score, charl_wscore=wscore, charl_index=index, charl_windex=windex)
        
        incProgress(0.5, detail = paste("score de Elixhauser"))
        
        elix <- comorbidity(x = diagnostics, id = "nas", code = "diag", score = "elixhauser", icd = "icd10", assign0 = FALSE) %>% 
          dplyr::select(nas, elix_score=score, elix_wscore_ahrq=wscore_ahrq, elix_wscore_vw=wscore_vw, elix_index=index, elix_windex_ahrq=windex_ahrq, elix_windex_vw=windex_vw)
  ...
  #################################################################
  #Sélection des séjours après click "selection services-GHM"
  #################################################################
  ...
  observeEvent(eventExpr = input$calcul, ignoreInit = TRUE, {
    ...
    output$activ1 <- DT::renderDT( {
      ...
      rsa %>% dplyr::filter(as.numeric(moissor)<=mese, as.numeric(ansor)>=anno-1) %>% 
        dplyr::group_by(ansor, moissor) %>% 
        dplyr::summarise(n1=n_distinct(nas), 
                         n2=n_distinct(nas[nbrum==1]), 
                         ip=round(sum(duree)/sum(dms_n, na.rm=TRUE),3)) %>%
        dplyr::select("Année de sortie"=ansor, "Mois de sortie"=moissor, "Nbr de séjours"=n1, "Nb de séjours monorums"=n2, "IP sejours"=ip)
    ...
    output$activ2 <- DT::renderDT( {
      ...
      twosteps <- function (x, var, niv1='ansor_sej', niv2='moissor_sej', niv3='nas', niv4='LIBUM', fct=list(mean=mean, median=median, rec=sum, nbrap=n_distinct)) {
        dplyr::group_by(x, !!sym(niv1), !!sym(niv2), !!sym(niv3), !!sym(niv4)) %>% 
          dplyr::summarise(s=sum(!!sym(var), na.rm=TRUE)) %>% 
          dplyr::ungroup() %>%
          dplyr::group_by(!!sym(niv4), !!sym(niv1), !!sym(niv2)) %>% 
          dplyr::summarise_at('s', fct, na.rm = TRUE) %>% 
          dplyr::rename_at(vars(names(.) %>% tail(length(fct))), ~ paste0(var,"_",.))
      }
      
      tempip <- rum %>% dplyr::filter(uma_locale2 %in% unita, as.numeric(moissor_sej)<=mese) %>%
        dplyr::group_by(LIBUM, ansor_sej) %>% 
        dplyr::summarise(ip_repa_mean=round(sum(dureesejpart*coefpmctmonotime1)/sum(dms_n_sej*coefpmctmonotime1, na.rm=TRUE),3))
      ...
      dplyr::left_join(tempdms, tempdmr) %>% dplyr::left_join(., tempip) %>% dplyr::ungroup() %>% dplyr::select(-LIBUM) %>% dplyr::rename("Année de sortie"=ansor_sej, DMS=duree_sej_mean, DMedianeS=duree_sej_median, DMR=dureesejpart_mean, DMedianeR=dureesejpart_median, "IP ventilé"=ip_repa_mean) %>% dplyr::mutate_at(vars(-1), ~round(., 2))
    ...
    output$activ3 <- DT::renderDT( {
      ...
      rsa %>% dplyr::filter(as.numeric(moissor)<=mese, as.numeric(ansor)>=anno-1) %>% 
        dplyr::mutate(typehosp = case_when(nbseance > 0 ~ "Séances", 
                                           duree == 0 ~ "Sans nuité hors séances", 
                                           duree > 0 & duree <= 2 ~ "HC <= 2 jours", 
                                           duree > 2 ~ "HC > 2 jours", TRUE ~"ERREUR") ) %>% 
        dplyr::group_by(Année=ansor, "Type d'hospitalisation"=typehosp) %>% 
        dplyr::summarise("Nbr de séjours"=n_distinct(nas))
    ...
    output$activ4 <- renderPlotly({
      ...
      temp1 <- rsa %>% dplyr::filter(as.numeric(ansor)>=anno-1) %>% 
        dplyr::mutate(ghs=noghs, typehosp = case_when(nbseance > 0 ~ "Séances", 
                                                      duree == 0 ~ "Sans nuité hors séances", 
                                                      duree > 0 & duree <= 2 ~ "HC <= 2 jours", 
                                                      duree > 2 ~ "HC > 2 jours", TRUE ~"ERREUR") ) %>% 
        dplyr::filter(ansor>=anno-1) %>% dplyr::mutate(temps=as.factor(paste0(ansor, " - M", moissor))) %>% 
        dplyr::group_by(typehosp, temps) %>% dplyr::summarise(nbr_sejours=n_distinct(nas)) %>% 
        dplyr::ungroup()
      
      ggplotly(ggplot(temp1, 
                      (aes(x = temps,  
                           y = nbr_sejours, 
                           group = typehosp, 
                           fill = typehosp))) + 
    ...
    output$activ5 <- DT::renderDT( {
      ...
      rsa %>% dplyr::filter(as.numeric(moissor)<=mese, as.numeric(ansor)>=anno-1) %>% 
        dplyr::mutate(typehosp = case_when(nbseance > 0 ~ "HP en seances", 
                                           duree > 0 & !gpcompx %in% c("T", "J") ~ "HC", 
                                           duree > 0 & gpcompx == "T" ~ "HC de très courte durée", 
                                           duree == 0 & gpcompx == "J" ~ "HC pour ambulatoire", 
                                           duree > 0 ~ "HC", 
                                           duree == 0 ~ "HP", 
                                           TRUE ~"ERREUR") ) %>% 
        dplyr::group_by(Année=ansor, "Type d'hospitalisation"=typehosp) %>% 
    ...
    output$activ6 <- renderPlotly({
      ...
      temp1 <- rsa %>% dplyr::filter(as.numeric(ansor)>=anno-1) %>% 
        dplyr::mutate(ghs=noghs, 
                      typehosp = case_when(nbseance > 0 ~ "HP en seances", 
                                           duree > 0 & !gpcompx %in% c("T", "J") ~ "HC", 
                                           duree > 0 & gpcompx == "T" ~ "HC de très courte durée", 
                                           duree == 0 & gpcompx == "J" ~ "HC pour ambulatoire", 
                                           duree > 0 ~ "HC", duree == 0 ~ "HP", TRUE ~"ERREUR") ) %>% 
        dplyr::filter(ansor>=anno-1) %>% dplyr::mutate(temps=as.factor(paste0(ansor, " - M", moissor))) %>% 
        dplyr::group_by(typehosp, temps) %>% dplyr::summarise(nbr_sejours=n_distinct(nas)) %>% 
        dplyr::ungroup()
      
      ggplotly(ggplot(temp1, (aes(x = temps,  
                                  y = nbr_sejours, 
                                  group = typehosp, 
                                  fill = typehosp))) + 
                 geom_area() + 
    ...
    output$activ7 <- renderPlotly({
      ...
      temp1 <- rsa %>% dplyr::mutate(ghs=noghs) %>% dplyr::filter(ansor>=anno-1) %>% 
        dplyr::mutate(type=substr(ghm,3,3), temps=paste0(ansor, " - M", moissor)) %>% 
        dplyr::group_by(type, temps) %>% 
        dplyr::summarise(nbr_sejours=n_distinct(nas)) %>% ungroup()
    ...
    output$activ8 <- renderPlotly({
      ...
      temp1 <- rsa %>% dplyr::mutate(ghs=noghs) %>% dplyr::filter(ansor>=anno-1) %>% 
        dplyr::mutate(severite=substr(ghm,6,6), temps=paste0(ansor, " - M", moissor)) %>% 
        dplyr::group_by(severite, temps) %>% dplyr::summarise(nbr_sejours=n_distinct(nas)) %>% 
        ungroup()
    ...
    output$activ9 <- renderPlotly({
      ...
      if(score==1) {
        temp1 <- rsa %>% dplyr::filter(ansor>=anno-1) %>% 
          dplyr::mutate(temps=paste0(ansor, " - M", moissor), 
                        gpcompx=as.integer(gpcompx), 
                        max_charl_score=max(charl_score), 
                        max_elix_score=max(charl_score), 
                        max_gpcompx=max(gpcompx, na.rm=TRUE)) %>% 
          dplyr::group_by(temps) %>% 
          dplyr::summarise(meanstd_score_charlson=mean(charl_score)/max(max_charl_score), 
                           meanstd_ghm_severity=mean(gpcompx, na.rm=TRUE)/max(max_gpcompx), 
                           meanstd_score_elixhauser=mean(elix_score)/max(max_elix_score)) %>% 
          ungroup()
        
        plot_ly(data=temp1, 
                x = ~temps, 
                y = ~meanstd_score_charlson, 
                name = 'Mean standardised Charlson score', 
                type = 'scatter', 
                mode = 'lines', 
                line = list(color = 'rgb(205, 12, 24)', width = 4)) %>%
          add_trace(y = ~meanstd_ghm_severity, 
                    name = 'Mean standardised GHM severity', 
                    line = list(color = 'rgb(22, 96, 167)', 
                                width = 4, 
                                dash = 'dash')) %>%
          add_trace(y = ~meanstd_score_elixhauser, 
                    name = 'Mean standardised Elixhauser score', 
                    line = list(color = 'rgb(0, 0, 0)', 
                                width = 4)) %>%
          layout(title = "Evolution de la comorbidité des séjours", 
                 xaxis = list(title = "Temps"), 
                 yaxis = list (title = "Comorbidité standardisée sur la période"))
      } else {
    ...
    output$activ10 <- renderPlotly({
      ...
      if(score==1) {
        ...
        temp1 <- rsa %>% dplyr::filter(as.numeric(ansor) >= anno-1, as.numeric(moissor) <= mese) %>% 
          dplyr::group_by(annee=factor(ansor), score=factor(charl_index), .drop=FALSE) %>%  
          dplyr::summarise(activ=n())
        ...
        plot_ly(type = 'bar', 
                ...
                y=~score, 
                color=~annee) %>% 
          layout(title='Evolution de la comorbidité', 
                 xaxis = list(title = 'Nombre de séjours'), 
                 yaxis = list(title = 'Score de Charlson'), 
                 barmode = 'group')
    ...
    output$activ11 <- DT::renderDT( {
      ...
      rsa %>% dplyr::filter(as.numeric(moissor)<=mese, as.numeric(ansor)>=anno-1) %>% 
        dplyr::group_by(Année=ansor, Racine = libelle_racine, "Domaine d'activité"=libelle_da, "Groupe d'activité"=libelle_ga, GHM=ghm) %>% 
        dplyr::summarise("Nbr de séjours"=n_distinct(nas), DMS=round(sum(duree)/n_distinct(nas), 1), 
                         "Pourcentage de monorums"=round(sum(nbrum[nbrum==1])/sum(nbrum)*100, 1))
  ...
  observeEvent(input$menuchoice, {
    ...
    if(input$menuchoice=="valoglob") {
      ...
      output$valo0 <- DT::renderDT( {
        ...
        rsa %>% dplyr::filter(as.numeric(moissor)<=mese, as.numeric(ansor)>=anno-1)  %>% 
          dplyr::summarise("Nbr de séjours annee n"=n_distinct(nas[ansor==anno]), 
                           "Séjours monorums n"=n_distinct(nas[nbrum==1 & ansor==anno]), 
                           "Valorisation GHS total annee n"=sum(rec_totale[ansor==anno]), 
                           "Valorisation monorum n"=sum(rec_totale[nbrum==1 & ansor==anno]), 
                           "Nbr de séjours annee n-1"=n_distinct(nas[ansor==anno-1]), 
                           "Séjours monorums n-1"=n_distinct(nas[nbrum==1 & ansor==anno-1]), 
                           "Valorisation GHS total annee n-1"=sum(rec_totale[ansor==anno-1]), 
                           "Valorisation monorum n-1"=sum(rec_totale[nbrum==1 & ansor==anno-1]), 
                           "IP moyen n"= sum(duree[ansor==anno])/sum(dms_n[ansor==anno], na.rm=TRUE),
                           "IP moyen n-1"= sum(duree[ansor==anno-1])/sum(dms_n[ansor==anno-1], na.rm=TRUE) ) %>% 
          dplyr::mutate_at(vars(2:8), ~round(., 0)) %>% dplyr::mutate_at(vars(9:10), ~round(., 3))
      ...
      output$valo1 <- DT::renderDT( {
        ...
        rsa %>% dplyr::filter(as.numeric(moissor)<=mese, as.numeric(ansor)>=anno-1) %>% 
          dplyr::group_by("Mois de sortie"=moissor) %>% 
          dplyr::summarise("Nbr de séjours annee n"=n_distinct(nas[ansor==anno]), 
                           "Séjours monorums n"=n_distinct(nas[nbrum==1 & ansor==anno]), 
                           "Valorisation GHS total annee n"=sum(rec_totale[ansor==anno]), 
                           "Valorisation monorum n"=sum(rec_totale[nbrum==1 & ansor==anno]), 
                           ...
                           "IP moyen n"= sum(duree[ansor==anno])/sum(dms_n[ansor==anno], na.rm=TRUE), 
                           "IP moyen n-1"= sum(duree[ansor==anno-1])/sum(dms_n[ansor==anno-1], na.rm=TRUE) ) %>% 
          dplyr::mutate_at(vars(2:9), ~round(., 0)) %>% dplyr::mutate_at(vars(10:11), ~round(., 3))
      ...
      output$valo3 <- renderPlotly({
        ...
        plot_ly(valograph3, 
                ...
                mode = 'markers', 
                hoverinfo = 'text', 
                text = ~paste('</br> nas: ', nas, '</br> GHM: ', ghm, '</br> duree sejour: ', duree, '</br> recette tot: ', round(rec_totale,1))) %>% 
          layout(titlefont=list(size=18), 
                 xaxis=list(autorange = TRUE,
                            title = "Durée des séjours"), 
                 yaxis=list(autorange = TRUE,
                            title = "Valorisation des séjours (€)"))
        
      })
      
      output$valo4 <- renderPlotly({
        
        temp1 <- rsa %>% dplyr::mutate(ghs=noghs) %>% 
          dplyr::filter(ansor>=anno-1) %>% 
          dplyr::mutate(type=factor(substr(ghm,3,3)), temps=as.factor(paste0(ansor, " - M", moissor))) %>% 
          dplyr::group_by(type, temps) %>% dplyr::summarise(recettes=sum(rec_totale)) %>% 
          dplyr::ungroup()
        ggplotly(ggplot(temp1, 
                        (aes(x = temps,  y = recettes, group = type, fill = type))) + 
                   geom_area() + 
                   theme(axis.text.x = element_text(angle = 66)), 
                 tooltip = "y" )
      ...
      output$valo5 <- renderPlotly({
        ...
        temp1 <- rsa %>% dplyr::mutate(ghs=noghs) %>% 
          dplyr::filter(ansor>=anno-1) %>% 
          dplyr::mutate(severite=factor(substr(ghm,6,6)), temps=as.factor(paste0(ansor, " - M", moissor))) %>% 
          dplyr::group_by(severite, temps) %>% dplyr::summarise(recettes=sum(rec_totale)) %>% 
          dplyr::ungroup()
        
        ggplotly(ggplot(temp1, (aes(x = temps,  y = recettes, group = severite, fill = severite))) + 
                   geom_area() + 
                   theme(axis.text.x = element_text(angle = 66)), 
                 tooltip = "y" )
      ...
      output$valo6 <- renderPlotly({
        ...
        temp1 <- left_join(rsa %>% dplyr::mutate(ghs=noghs), tarifs %>% 
                             dplyr::select(ghs, ghm, borne_basse_t=borne_basse, borne_haute_t=borne_haute, anseqta)) %>% 
          dplyr::filter(ansor>=anno-1, duree>borne_haute_t)
        
        plot_ly(data = temp1, 
                x = ~paste0(ansor, " - M", moissor), 
                y = ~duree, type = 'scatter', 
                mode = 'markers', 
                marker = list(size = ~rec_totale/1000, opacity = 0.5), 
                text=paste("recette=",round(temp1$rec_totale,0), " €")) %>% 
          layout(title="Durée et valorisation des séjours dépassant la borne haute", 
                 xaxis = list(title = "Temps"), 
                 yaxis = list(title = "Durée totale du séjour (jours)"))
  ...
  observeEvent(input$menuchoice, {
    ...
    if(input$menuchoice=="pmct") {
      ...
      output$pmct1 <- renderPlotly({
        
        df1 <- rum %>% dplyr::filter(LIBUM %in% unitemed, ansor_sej>=anno-1) %>% 
          dplyr::group_by(ansor_sej, moissor_sej, nas, LIBUM) %>% 
          dplyr::summarise(s1=sum(valopmctmonotime1), s2=sum(valopmctmonotime1_tarifsante)) %>% 
          dplyr::ungroup() %>%
          dplyr::group_by(LIBUM, ansor_sej, moissor_sej) %>% 
          dplyr::summarise(pmct_pmctmonotime1=mean(s1), valopmctmonotime1_tarifsante_mean=mean(s2, na.rm=TRUE))  
        
        df2 <- twosteps(x=rum %>% dplyr::filter(LIBUM %in% unitemed, ansor_sej>=anno-1), var='valopmctmonotime1', niv2='')

        df3 <- twosteps(x=rum %>% dplyr::filter(LIBUM %in% unitemed, ansor_sej==anonconsol, as.numeric(moissor_sej)==mnonconsol), var='valopmctmonotime1_nonconsol', niv2='')
        
        plot_ly(data=df1, 
                x = ~moissor_sej, 
                y = ~pmct_pmctmonotime1, 
                type = 'scatter', 
                mode = 'lines', 
                color = ~as.factor(ansor_sej), 
                line = list(width=4)) %>%
          add_trace(y = ~valopmctmonotime1_tarifsante_mean, 
                    name = 'tarifs_anterieurs', 
                    line = list(color = 'rgb(22, 96, 167)',
                                width = 1, 
                                dash = 'dash')) %>%
          add_segments(data=df2, 
                       x = 01, 
                       xend = 12, 
                       y = ~valopmctmonotime1_mean, 
                       yend = ~valopmctmonotime1_mean, 
                       line = list(width = 1, dash = 'dash'), 
                       name=c(paste('pmct annuel', anno-1), 
                              paste('pmct annuel', anno))) %>%
          add_markers(data=df3, 
                      x = mnonconsol, 
                      y=~valopmctmonotime1_nonconsol_mean, 
                      name=paste('pmct consolidé', anno-1), 
                      marker = list(symbol = 'hexagram-dot', 
                                    size = 15, 
                                    width=4)) %>%
          layout(title = "Evolution mensuelle du pmct", xaxis = list(title = "Mois"), yaxis = list(title = "Valorisation moyenne"))
      ...
      output$pmct2 <- DT::renderDT({
        ...
        dplyr::left_join(tempmct1, tempmct2) %>% dplyr::left_join(., tempmct3) %>% 
          dplyr::ungroup() %>% 
          dplyr::select(ansor_sej, 
                        dplyr::ends_with("_mean"), 
                        dplyr::ends_with("_median")) %>% 
          dplyr::rename("Année de sortie"=ansor_sej, 
                        PMCT=valopmctmonotime1_mean, 
                        "PMCT tarifs antérieurs"=valopmctmonotime1_tarifsante_mean, 
                        !!paste0("PMCT non consolidé à M", mnonconsol):=valopmctmonotime1_nonconsol_mean, 
                        PMedianCT=valopmctmonotime1_median, 
                        "PMedianCT tarifs antérieurs"=valopmctmonotime1_tarifsante_median, 
                        !!paste0("PMedianCT non consolidé à M", mnonconsol):=valopmctmonotime1_nonconsol_median) %>% 
          dplyr::mutate_at(vars(2:7), ~round(., 1))
        
      }, 
      caption = paste0("PMCT annuel à M", mese, " pour ", unitemed, " selon les tarifs en cours ou précédent avec PMCT consolidé à M", mnonconsol ), 
      rownames=FALSE, 
      extensions = 'Buttons', 
      filter = 'top', 
      ...
      output$pmct3 <- DT::renderDT({
        ...
        rum %>% dplyr::filter(LIBUM %in% unitemed, ansor_sej >= anno-1) %>% 
          dplyr::group_by(nas, type=substr(cdghm,3,3), ansor_sej) %>% 
          dplyr::summarise(s1=sum(valopmctmonotime1, na.rm = TRUE), 
                           s2=sum(valopmctmonotime2, na.rm = TRUE)) %>% 
          dplyr::group_by(type, "Année"=ansor_sej) %>% 
          dplyr::summarise("Valorisation totale ventilée selon pmct monorums et journées" = sum(s1, na.rm = TRUE), 
                           "PMCT selon pmct monorums et journées" = mean(s1, na.rm = TRUE), 
                           "mediane" =  median(s1, na.rm = TRUE), 
                           "Valorisation totale ventilée selon pmct monorums et journées à parité" = sum(s2, na.rm = TRUE), 
                           "PMCT selon pmct monorums et journées à parité" = mean(s2, na.rm = TRUE), 
                           "mediane" = median(s2, na.rm = TRUE)) %>% 
          dplyr::mutate_at(vars(3:7), ~round(., 1))
        
      }, 
      caption=paste0(anno-1, " - ",anno, ": PMCT en CHKMZ à M", mese), 
      rownames=FALSE, 
      extensions = 'Buttons', 
      filter = 'top', 
      options = list(dom = 'Blfrtip', buttons = c('copy', 'csv', 'excel')))
      ...
      output$pmct4 <- DT::renderDT({
        ...
        rum %>% dplyr::filter(LIBUM %in% unitemed, ansor_sej >= anno-1) %>% 
          dplyr::group_by(nas, sévérité=(substr(cdghm,6,6)), ansor_sej) %>% 
          dplyr::summarise(s1=sum(valopmctmonotime1, na.rm = TRUE), s2=sum(valopmctmonotime2, na.rm = TRUE)) %>% 
          dplyr::group_by(sévérité, "Année"=ansor_sej) %>% 
          dplyr::summarise("Valorisation totale ventilée selon pmct monorums et journées" = sum(s1, na.rm = TRUE), 
                           "PMCT selon pmct monorums et journées" = mean(s1, na.rm = TRUE), 
                           "mediane" =  median(s1, na.rm = TRUE), 
                           "Valorisation totale ventilée selon pmct monorums et journées à parité" = sum(s2, na.rm = TRUE), 
      ...
      caption=paste0(anno-1, " - ",anno, ": PMCT selon sévérité à M", mese), 
      rownames=FALSE, 
      extensions = 'Buttons', 
      filter = 'top', 
      options = list(dom = 'Blfrtip', buttons = c('copy', 'csv', 'excel')))
      ...
      output$pmct5 <- renderPlot({
        ...
        pmctgraph5 <- rum %>% dplyr::filter(LIBUM %in% unitemed, as.numeric(ansor_sej) >= anno-1, as.numeric(moissor_sej) <= mese) %>% 
          dplyr::select(norss, nas, cdghm, dureesejpart, duree_sej, LIBUM, ansor_sej, valotime:valopmctmonotime2)
      ...
      output$pmct6 <- renderPlotly({
        ...
        pmctgraph6 <- rum %>% dplyr::filter(LIBUM %in% unitemed, as.numeric(ansor_sej) >= anno-1, as.numeric(moissor_sej) <= mese) %>% 
          dplyr::select(norss, nas, cdghm, dureesejpart, duree_sej, LIBUM, ansor_sej, valotime:valopmctmonotime2)
      ...
      output$pmct7 <- DT::renderDT({
        ...
        rum %>% dplyr::filter(LIBUM %in% unitemed, as.numeric(ansor_sej)>=anno-1, as.numeric(moissor_sej) <= mese) %>% 
          dplyr::group_by("Année"=ansor_sej) %>% 
          dplyr::summarise("Nbr de séjours"=n_distinct(nas), 
                           "Nbr de séjours monorums"=n_distinct(nas[nbrum_sej==1]), 
                           "Pourcentage de séjours monorums"=round(n_distinct(nas[nbrum_sej==1])/n_distinct(nas)*100,2), 
                           "Pourcentage de séjours multirums"=round(n_distinct(nas[nbrum_sej>1])/n_distinct(nas)*100,2))
      ...
      output$pmct8 <- DT::renderDT({
        ...
        caption=paste("PMCT des sejours monorums pour", unitemed, "sur les 12 derniers mois (utilisé pour les clefs de répartition)"), 
      ...
      output$pmct9 <- DT::renderDT({
        ...
        listeum <- rum %>% filter(ansor_sej>=anno-1, as.numeric(moissor_sej)<=mese) %>% 
          filter(norss%in%norss[LIBUM %in% unitemed]) %>% 
          dplyr::count(LIBUM, ansor_sej) %>% dplyr::arrange(-n) 
        
        pmctmono %>% dplyr::mutate(ansor_sej=ansor) %>% dplyr::left_join(., rum %>% 
                                                                    dplyr::select(cdurm, ansor_sej, LIBUM) %>% distinct()) %>% 
          dplyr::filter(LIBUM %in% listeum$LIBUM, !LIBUM %in% unitemed, as.numeric(ansor)>=anno-1) %>% 
          dplyr::left_join(., listeum) %>% 
          dplyr::mutate(ansor_sej=as.integer(ansor_sej)) %>%  
          dplyr::group_by(LIBUM) %>% 
          dplyr::mutate(nstot=sum(n)) %>% 
          dplyr::ungroup() %>% 
          dplyr::group_by(LIBUM, ansor_sej) %>% 
          dplyr::summarise(recmono=sum(recbeenosup), nbmono=sum(nbnosup), ns=sum(n), nstot=first(nstot)) %>% 
          dplyr::arrange(-nstot, desc(LIBUM), -ansor_sej) %>% 
          dplyr::transmute("Année (12 derniers mois)"=ansor_sej, 
                           "Nbr de séjours monorums"=nbmono, 
                           "PMCT monorum"=round(recmono/nbmono,1),
                           "Nbr de séjours partagés"=ns) %>% 
          dplyr::ungroup() %>% dplyr::rename(unite=LIBUM)
        
      }, 
      caption=paste("PMCT des seuls sejours monorums pour les unités partageant des sejours avec", unitemed, "sur les 12 derniers mois (utilisé pour les clefs de répartition)"), 
      rownames=FALSE, 
      extensions = 'Buttons', 
      filter = 'top', 
      options = list(dom = 'Blfrtip', buttons = c('copy', 'csv', 'excel')))
      ...
      rad <- rum %>% dplyr::filter(nbrum_sej >= 2, is.element(nas, nas[LIBUM %in% unitemed]), as.numeric(ansor_sej) >= anno-1, as.numeric(moissor_sej) <= mese) %>% 
        dplyr::select(nas, LIBUM, ansor_sej, dureesejpart, duree_sej, norum, nbrum_sej, valotime, valopmctmono, valopmctmonotime1, valopmctmonotime2) %>% 
        dplyr::group_by(annee=factor(ansor_sej), unite=factor(LIBUM), .drop=FALSE) %>%  
        dplyr::summarise(prix_temps = sum(valotime, na.rm=TRUE), 
                         prix_pmct = sum(valopmctmono, na.rm=TRUE), 
                         prix_temps_pmct1 = sum(valopmctmonotime1, na.rm=TRUE), 
                         prix_temps_pmct2 = sum(valopmctmonotime2, na.rm=TRUE)) %>% 
        dplyr::mutate(ratio_temps = 100 * prix_temps / sum(prix_temps), # a revoir calcul proportion du temps passé
                      ratio_pmct = 100 * prix_pmct / sum(prix_pmct), 
                      ratio_temps_pmct1 = 100 * prix_temps_pmct1 / sum(prix_temps_pmct1), 
                      ratio_temps_pmct2 = 100 * prix_temps_pmct2 / sum(prix_temps_pmct2)) %>% 
        dplyr::ungroup() %>% dplyr::filter(is.element(unite, unite[ratio_temps_pmct1>2]) )
      ...
      # Evolution du coefficient de repartition selon l'année
      # revoir la signification axes et le calcul des valeur
      output$pmct11 <- renderPlot({
        ball <- left_join(rad, 
                          left_join(pmctmono, rum %>% dplyr::mutate(ansor=as.character(ansor_sej)) %>% 
                                      dplyr::select(cdurm, LIBUM, ansor) %>% distinct) %>% 
                            dplyr::group_by(LIBUM, ansor) %>% 
                            dplyr::summarise(r=sum(recbeenosup), n=sum(nbnosup)) %>% 
                            dplyr::mutate(pmctmono=r/n) %>% dplyr::select(LIBUM, ansor, pmctmono) %>% 
                            dplyr::rename(annee=ansor, unite=LIBUM) ) %>% 
          dplyr::rename(pmct_mono_nosup=pmctmono)
  ...
  observeEvent(input$menuchoice, {
    ...
    if(input$menuchoice=="parcours") {
      ...
      # a revoir pas très utile ici
      rad <- rum %>% dplyr::filter(nbrum_sej >= 2, 
                                   is.element(nas, nas[LIBUM %in% unitemed]), 
                                   as.numeric(ansor_sej) >= anno-1, 
                                   as.numeric(moissor_sej) <= mese) %>% 
        dplyr::select(nas, LIBUM, ansor_sej, dureesejpart, duree_sej, norum, nbrum_sej, valotime, valopmctmono, valopmctmonotime1, valopmctmonotime2) %>% 
        dplyr::group_by(annee=factor(ansor_sej), unite=factor(LIBUM), .drop=FALSE) %>%  
        dplyr::summarise(prix_temps = sum(valotime, na.rm=TRUE), prix_pmct = sum(valopmctmono, na.rm=TRUE), 
                         prix_temps_pmct1 = sum(valopmctmonotime1, na.rm=TRUE), 
                         prix_temps_pmct2 = sum(valopmctmonotime2, na.rm=TRUE)) %>% 
        dplyr::mutate(ratio_temps = 100 * prix_temps / sum(prix_temps), 
                      ratio_pmct = 100 * prix_pmct / sum(prix_pmct), 
                      ratio_temps_pmct1 = 100 * prix_temps_pmct1 / sum(prix_temps_pmct1), 
                      ratio_temps_pmct2 = 100 * prix_temps_pmct2 / sum(prix_temps_pmct2)) %>% 
        dplyr::ungroup() %>% 
        dplyr::filter(is.element(unite, unite[ratio_temps_pmct1>2]) )
      
      
      ball <- left_join(rad, 
                        left_join(pmctmono, 
                                  rum %>% dplyr::mutate(ansor=as.character(ansor_sej)) %>% 
                                    dplyr::select(cdurm, LIBUM, ansor) %>% distinct) %>% 
                          dplyr::group_by(LIBUM, ansor) %>% dplyr::summarise(r=sum(recbeenosup), n=sum(nbnosup)) %>% 
                          dplyr::mutate(pmctmono=r/n) %>% dplyr::select(LIBUM, ansor, pmctmono) %>% 
                          dplyr::rename(annee=ansor, unite=LIBUM) ) %>% 
        dplyr::rename(pmct_mono_nosup=pmctmono)
      ...
      # Fonction qui retourne une liste de couleurs utilisées dans les sunbursts
